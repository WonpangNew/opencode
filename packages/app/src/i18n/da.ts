export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "Læs subagent-plan",
  "settings.permissions.tool.todoread.description": "Læs subagent-orchestreringsplanen",
  "settings.permissions.tool.todowrite.title": "Skriv subagent-plan",
  "settings.permissions.tool.todowrite.description": "Opdater subagent-orchestreringsplanen",
