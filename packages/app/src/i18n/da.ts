export const dict = {
  ...
  "settings.permissions.tool.taskread.title": "Læs opgaver",
  "settings.permissions.tool.taskread.description": "Læs opgavelisten",
  "settings.permissions.tool.taskwrite.title": "Skriv opgaver",
  "settings.permissions.tool.taskwrite.description": "Opdater opgavelisten",
