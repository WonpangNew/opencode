export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "サブエージェント計画読み込み",
  "settings.permissions.tool.todoread.description": "サブエージェント編成計画の読み込み",
  "settings.permissions.tool.todowrite.title": "サブエージェント計画書き込み",
  "settings.permissions.tool.todowrite.description": "サブエージェント編成計画の更新",
