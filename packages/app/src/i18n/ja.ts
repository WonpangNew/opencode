export const dict = {
  ...
  "settings.permissions.tool.taskread.title": "タスク読み込み",
  "settings.permissions.tool.taskread.description": "タスクリストの読み込み",
  "settings.permissions.tool.taskwrite.title": "タスク書き込み",
  "settings.permissions.tool.taskwrite.description": "タスクリストの更新",
