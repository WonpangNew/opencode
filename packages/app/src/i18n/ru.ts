export const dict = {
  ...
  "settings.permissions.tool.taskread.title": "Чтение списка задач",
  "settings.permissions.tool.taskread.description": "Чтение списка задач",
  "settings.permissions.tool.taskwrite.title": "Запись списка задач",
  "settings.permissions.tool.taskwrite.description": "Обновление списка задач",
