export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "Чтение плана подагентов",
  "settings.permissions.tool.todoread.description": "Чтение плана оркестрации подагентов",
  "settings.permissions.tool.todowrite.title": "Запись плана подагентов",
  "settings.permissions.tool.todowrite.description": "Обновление плана оркестрации подагентов",
