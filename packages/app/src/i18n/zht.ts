...
export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "讀取子智能體計劃",
  "settings.permissions.tool.todoread.description": "讀取子智能體編排計劃",
  "settings.permissions.tool.todowrite.title": "更新子智能體計劃",
  "settings.permissions.tool.todowrite.description": "更新子智能體編排計劃",
