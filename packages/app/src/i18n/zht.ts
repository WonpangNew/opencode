...
export const dict = {
  ...
  "settings.permissions.tool.taskread.title": "讀取任務",
  "settings.permissions.tool.taskread.description": "讀取任務清單",
  "settings.permissions.tool.taskwrite.title": "更新任務",
  "settings.permissions.tool.taskwrite.description": "更新任務清單",
