export const dict = {
  ...
  "settings.permissions.tool.taskread.title": "Odczyt zadań",
  "settings.permissions.tool.taskread.description": "Odczyt listy zadań",
  "settings.permissions.tool.taskwrite.title": "Zapis zadań",
  "settings.permissions.tool.taskwrite.description": "Aktualizacja listy zadań",
