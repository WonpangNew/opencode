export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "Odczyt planu subagentów",
  "settings.permissions.tool.todoread.description": "Odczyt planu orkiestracji subagentów",
  "settings.permissions.tool.todowrite.title": "Zapis planu subagentów",
  "settings.permissions.tool.todowrite.description": "Aktualizacja planu orkiestracji subagentów",
