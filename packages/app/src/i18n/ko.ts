...
export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "서브에이전트 계획 읽기",
  "settings.permissions.tool.todoread.description": "서브에이전트 오케스트레이션 계획 읽기",
  "settings.permissions.tool.todowrite.title": "서브에이전트 계획 쓰기",
  "settings.permissions.tool.todowrite.description": "서브에이전트 오케스트레이션 계획 업데이트",
