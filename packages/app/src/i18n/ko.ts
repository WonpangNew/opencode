...
export const dict = {
  ...
  "settings.permissions.tool.taskread.title": "작업 읽기",
  "settings.permissions.tool.taskread.description": "작업 목록 읽기",
  "settings.permissions.tool.taskwrite.title": "작업 쓰기",
  "settings.permissions.tool.taskwrite.description": "작업 목록 업데이트",
