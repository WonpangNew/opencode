...
export const dict = {
  ...
  "settings.permissions.tool.taskread.title": "读取任务",
  "settings.permissions.tool.taskread.description": "读取任务列表",
  "settings.permissions.tool.taskwrite.title": "更新任务",
  "settings.permissions.tool.taskwrite.description": "更新任务列表",
