...
export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "读取子智能体计划",
  "settings.permissions.tool.todoread.description": "读取子智能体编排计划",
  "settings.permissions.tool.todowrite.title": "更新子智能体计划",
  "settings.permissions.tool.todowrite.description": "更新子智能体编排计划",
