...
export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "Subagenten-Plan lesen",
  "settings.permissions.tool.todoread.description": "Den Subagenten-Orchestrierungsplan lesen",
  "settings.permissions.tool.todowrite.title": "Subagenten-Plan schreiben",
  "settings.permissions.tool.todowrite.description": "Den Subagenten-Orchestrierungsplan aktualisieren",
