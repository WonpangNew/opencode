export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "Subagent Plan Read",
  "settings.permissions.tool.todoread.description": "Read the subagent orchestration plan",
  "settings.permissions.tool.todowrite.title": "Subagent Plan Write",
  "settings.permissions.tool.todowrite.description": "Update the subagent orchestration plan",
