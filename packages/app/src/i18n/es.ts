export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "Leer plan de subagentes",
  "settings.permissions.tool.todoread.description": "Leer el plan de orquestación de subagentes",
  "settings.permissions.tool.todowrite.title": "Escribir plan de subagentes",
  "settings.permissions.tool.todowrite.description": "Actualizar el plan de orquestación de subagentes",
