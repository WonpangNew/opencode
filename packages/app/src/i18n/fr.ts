export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "Lire le plan des sous-agents",
  "settings.permissions.tool.todoread.description": "Lire le plan d'orchestration des sous-agents",
  "settings.permissions.tool.todowrite.title": "Écrire le plan des sous-agents",
  "settings.permissions.tool.todowrite.description": "Mettre à jour le plan d'orchestration des sous-agents",
