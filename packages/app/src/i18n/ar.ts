export const dict = {
  ...
  "settings.permissions.tool.todoread.title": "قراءة خطة الوكلاء الفرعيين",
  "settings.permissions.tool.todoread.description": "قراءة خطة تنسيق الوكلاء الفرعيين",
  "settings.permissions.tool.todowrite.title": "كتابة خطة الوكلاء الفرعيين",
  "settings.permissions.tool.todowrite.description": "تحديث خطة تنسيق الوكلاء الفرعيين",
